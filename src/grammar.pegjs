Query
  = __ cond:PrimaryCondition __ modifier:PrimaryModifier? __ {
    return {
      type: "Query",
      condition: cond,
      modifier: modifier
...
Condition "condition"
  = key:Identifier __ op:Operator __ value:Expression {
    return {
      type: "Condition",
      key: key,
      op: op,
...
BinaryCondition
  = head:Condition __ op:BinaryOperator __ tail:PrimaryCondition {
    return {
...
PrimaryCondition
  = BinaryCondition
  / Condition
  / "(" __ cond:PrimaryCondition __ ")" { return cond; }
...
/*ModifierList
  = head:Modifier tail:ModifierListTail*/
...
OrderByClause
  = op:OrderByToken __ head:Identifier tail:OrderByClauseTail* __ direction:OrderByDirection? {
    return {
      "type": "Modifier",
      "op": op,
      direction: direction,
...
OrderByToken "order by"
  = "ORDER"i __ "BY"i { return "ORDER_BY"; }
...
Tuple "tuple"
  = "(" __ head:Expression __ tail:TupleTail* __ ")" {
    return {
      type: "Tuple",
      value: [head].concat(tail)
    };
...
Operator "operator"
  ...
  / "<" { return "LESS_THAN"; }
  / "IN"i { return "IN"; }
  / "NOT"i __ "IN"i { return "NOT_IN"; }
  / "IS"i { return "IS"; }
  / "IS"i __ "NOT"i { return "IS_NOT"; }
  / "WAS" { return "WAS"; }
  / "WAS"i __ "IN"i { return "WAS_IN"; }
  / "WAS"i __ "NOT"i { return "WAS_NOT"; }
  / "WAS"i __ "NOT"i __ "IN"i { return "WAS_NOT_IN"; }
  / "CHANGED"i { return "CHANGED"; }
...
EmptyLiteral
  = EmptyToken { return { type: "Literal", value: null /*TODO*/ }; }
